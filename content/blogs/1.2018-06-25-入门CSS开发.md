...
image: https://cdn.clearlywind.com/blog-images/images/css.png
alt: 入门CSS开发
ogImage: https://cdn.clearlywind.com/blog-images/logo/css.png
tags: ['PostCSS', 'CSS']
published: true
_path: /blogs/入门CSS开发
---
...
> `BEM` 是块（block）、元素（element）、修饰符（modifier）的简写，由 [Yandex](https://github.com/yandex) 团队提出的一种前端 CSS 命名方法论
...
使用两个连字符和下划线而不是一个，是为了让你自己的块可以用单个连字符来界定。其中块可以用单个连字符来界定。比如：
